			       ...
			       <form  name="form1" method="post" enctype="multipart/form-data">
				      <div class="orderReview">
					      <dl class="clearfix">
							 ...
							 <dd>
							      Butter Chicken
							      <p class="extra"><span>Extra</span> : Spice</p>
							 </dd>
					  ...
					  <div class="orderReview">
					      <dl class="clearfix">
							 ...
							 <dt>Food Item</dt>
							 <dd> Butter Chicken<p class="extra"><span>Extra</span> : Spice</p>
							 </dd>
							 ...
							 <dt>Instruction</dt>
							 <dd><p>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. version  of Lorem Ipsum. Proin gravida nibh vel velit                             auctor  aliquet.</p>
							 </dd>
							 
						  </dl>
					  </div>
					  
					  <div class="orderTimeDetail">
						  <dl class="clearfix">
							  <dt>Time</dt>
							  <dd>06. 30 PM</dd>
					  ...
					  <div class="orderChoiceBtn clearfix">
					     <input type="button" value="Edit Order" onClick="window.location.href='order.html'">
						 <input type="button" value="Confirm Order" onClick="window.location.href='thank.html'">
					  </div>
