        	...
        	<div class="pagewidth">
				...
				<ul>
                    ...
                    <li><input type="password" placeholder="Password"/>
                    	<div class="forgotPassword"><label><input type="checkbox"/> Remember Me</label> <a href="forgot-password.html">Forgot Password</a> </div>
                    </li>
                    <li class="tcenter"><input type="submit" value="Submit "/></li>
                </ul>
